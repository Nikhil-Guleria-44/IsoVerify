# 🎯 IsoVerify - Quality Assurance for Radiation Therapy
...
1. Open the application from your Start Menu (Windows), Applications folder (macOS), or through terminal (Linux).
2. Follow the on-screen instructions to select the test type.
3. Input your measurement data when prompted.
4. Review the results to ensure your linac is operating correctly.
...
1. Ensure you've downloaded the correct version for your OS.
